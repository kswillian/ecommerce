...
$app->get("/login", function(){
	...
	$page->setTpl("login", [
		...
		"registerValues"=>(isset($_SESSION['reisterValues'])) ? $_SESSION['reisterValues'] : ['name'=>'', 'email'=>'', 'phone'=>'']
	]);
...
$app->get("/boleto/:idorder", function($idorder){
	...
	$dadosboleto["endereco1"] = utf8_encode($order->getdesaddress() . " - ". $order->getdesdistrict(). " - ". $order->getdescity(). " - ". $order->getstate(). "". $order->getdescountry());
	$dadosboleto["endereco2"] = utf8_encode($order->getdescity(). " ". $order->getstate() . " - " . $order->getdescountry() . " - CEP: ".  $order->getdeszipcode());
...
$app->post("/profile/change-password", function(){
	...
	if( !isset($_POST['new_pass']) || $_POST['new_pass'] === ''){
		...
		User::setError('Digite a sua nova senha.');
		header("Location: /profile/change-password");
		exit;
